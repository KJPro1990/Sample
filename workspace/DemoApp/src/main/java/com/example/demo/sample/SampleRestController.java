...
public class SampleRestController {
	...
	public String result(@ModelAttribute SampleResource sampleResource, Model model) {
		model.addAttribute("formFields", service.generateFormFields());
		model.addAttribute("gridColumns", service.generateGridColumns());
		model.addAttribute("gridSearches", service.generateGridSearches());
		return "result";
	}
